...
typedef void (*funcfromwstring)(const std::wstring datetimestring, ymdhns& decoded);
typedef void (*functostring)(const int year,const int month,const int day, const int hour, const int minute,const int second);
typedef void (*functowstring)(const int year, const int month, const int day, const int hour, const int minute, const int second);
...
class datetime
{
  ...
  public:
    ...
    std::string towstring(functowstring func);
    ...
    void fromwstring(const std::wstring datetimestring);
    void fromwstring(const std::wstring datetimestring, funcfromwstring func); // with lambda adapter
